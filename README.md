...
Run `npm run refresh --prefix dirk-offers-dashboard -- --force` to fetch the latest offers, update `public/data/offers.json`, and record compact per-product price statistics in `data/offers.sqlite`.
